...
function printAnalysis(analysis: any) {
  ...
  // Use UTC date formatting for consistent display across timezones
  console.log('  Date Range:', `${formatUTCDate(analysis.dateRange.earliest)} to ${formatUTCDate(analysis.dateRange.latest)}`);
}
