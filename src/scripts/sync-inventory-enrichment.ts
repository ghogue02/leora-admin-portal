...
async function main() {
  ...
  const skuById = new Map<string, typeof allSkus[number]>();
  allSkus.forEach((sku) => {
  ...
  // Determine desired locations per SKU based on the CSV
  ...
  // Delete any CRM inventory rows that don't exist in the Well Crafted CSV
