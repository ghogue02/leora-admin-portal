...
function validateOrderData(
  ...
  // Note: Empty orders are skipped, not errors
  // Orders with only samples or no lines will be filtered during export
  // This is valid business logic (sample-only orders)
}
