...
```bash
DATABASE_URL="postgresql://postgres:***REMOVED***@***SUPABASE_HOST_REMOVED***:5432/postgres"
DIRECT_URL="postgresql://postgres:***REMOVED***@***SUPABASE_HOST_REMOVED***:5432/postgres"
```
